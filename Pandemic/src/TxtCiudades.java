...
public class TxtCiudades {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < ciudades.size(); i++) {
            ...
            for (int j = 0; j < ciu.getColindantes().size(); j++) {
                String colindante = (String) ciu.getColindantes().get(j);
    ...
    public static Ciudad asignarCiudades(String linea) {
        //Variables
        ...
        return new Ciudad(nombreCiudad, enfermedad, coords, ciudades);
    }
    ...
    public static double calcularDistancia(Ciudad ciudadMain, Ciudad colindante) {
        double longitud = 0;
        double altura = 0;
        double distancia = 0;
